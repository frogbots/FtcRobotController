...
import org.firstinspires.ftc.teamcode.trajectory.AutoDuckyWheelRed;
...
public class FreightFrenzyDUCKYAutoRedSM extends LinearOpMode {
    ...
    public void buildTrajectory() {
        ...
        HubToDuckPrison = new StateMTrajectory.Builder()
                ...
                .addMovement(new StateMPointApproach.Builder() //To Duck
                        ...
                        .stopMotorsOnDone(true)
                        .build())
                .addMovement(new AutoDuckyWheelRed())
