...
public class FreightFrenzyDUCKYAutoRed extends LinearOpMode {
        ...
        public void buildTrajectory()
        {
            trajectory = new Trajectory.Builder()
                    ...
                    .addMovement(new PointApproach.Builder() //BEGIN THE QUEST TO SAVE THE DUCK
                            .setTargetPosition(10.9,2.67)
                            .setMaxPower(0.4)
                            .setXyGain(.06)
                            .setTargetHeading(0)
                            ...
                            .build())
                    .addMovement(new DuckyWheel())//SAVE THE DUCK FROM HIS PRISON ON THE SPINNY THING
                    .addMovement(new SleepAction(1000)) //WAIT TO CHECK HIS HIGHNESS AS LANDED SAFLY
                    //.addMovement(new TSEDeploy())
                    .addMovement(new PointApproach.Builder() // PLACE MINERAL!!!!!!!!!!!!!!!!
                            .setTargetPosition(44,12)
                            .setMaxPower(0.5)
                            .setXyGain(.06)
                            .setTargetHeading(-210)
                            .setHeadingDynamicGain(new AcceleratedGain(.012, 0.0004))
                            .setMaxTurnPower(0.6)
                            .setMovementThresh(1)
                            .setHeadingThreshold(2)
