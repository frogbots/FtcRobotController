...
import static org.firstinspires.ftc.teamcode.Globals.LiftIsDown;
...
@TeleOp
public class FROGTeleOpOutreach extends LinearOpMode {
...
//    LynxModule module;
    ...
    AccerlationControlledDrivetrainPowerGeneratorForAuto acclCtrl;
        ...
        public void runOpMode() throws InterruptedException {
            ...
            TSEMotor = hardwareMap.get(DcMotorEx.class, "TSEMotor");
            module = (LynxModule) hardwareMap.get(LynxModule.class, "Expansion Hub 3");
            ctrl = hardwareMap.get(LynxDcMotorController.class, "Expansion Hub 3");
        ...
        //    else {Globals.DUCKwheel.setPower(0);}
           ...
           // }
            ...
            if (gamepad1.a) {
                ...
                Globals.RotationI.setPosition(.1);
            ...
            if (gamepad1.b) {Globals.Intake.setPower(0); Globals.RotationI.setPosition(.83);} //THIS IS NOT AUTO TRANSFER
...
`                RTW.setPower(0);
           ...
           if (gamepad1.x) {   //PLACE
            ...
            if (gamepad1.left_trigger > .3) {   //STOW
                //LiftGoDown = true;
            ...
            if (gamepad1.right_trigger > .5) {   //Allince Deploy
        ...
        if (Globals.LiftLimit.isPressed() && !LiftIsDown) {
               Globals.Lift.setPower(0);
               Globals.Lift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
               Globals.LiftIsDown = true;
        }
