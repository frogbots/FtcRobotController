...
public class HSV extends OpenCvPipeline {
        ...
        Scalar min = new Scalar(0, 70, 50);
        Scalar max = new Scalar(10, 255, 255);
        Scalar Hmin = new Scalar(170, 70, 50);
        Scalar Hmax = new Scalar(180, 255, 255);
        ...
        HSV.Stage[] stages = HSV.Stage.values();
        ...
        public Mat processFrame(Mat input) {
               ...
               List<MatOfPoint> contoursList = new ArrayList<>();
                ...
                Core.inRange(imageHSV, Hmin, Hmax, mask2);
