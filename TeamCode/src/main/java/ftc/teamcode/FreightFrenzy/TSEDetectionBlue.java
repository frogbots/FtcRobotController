...
public class TSEDetectionBlue extends OpenCvPipeline
{
    double TSEDenisty = 127;
    ...
    Mat YCrCb = new Mat();
    Mat Cr = new Mat();
    Point TopLeftPoint = new Point(40,60); // (0,0) is top left // 47 158
    ...
    Point TopLeftPoint2 = new Point(125,60); // (0,0) is top left
    Point BottomRightPoint2 = new Point(TopLeftPoint2.x + width, TopLeftPoint2.y + hight);

    Point TopLeftPoint3 = new Point(80,60); // (0,0) is top left // 47 158
