...
public class AUTOLiftPreLoadDuck extends StateMachine<AUTOLiftPreLoadDuck.State> implements StateMMovmentPerformer {
    ...
    public AUTOLiftPreLoadDuck.State getStAte()
    {
        return state;
    }
...
//                }
            ...
            case TURRET: {
                ...
                if(getElapsedStateTime() > 700 && Globals.ReadyToPlace) {
