...
public class JerkControlledTele extends LinearOpMode
{
    ...
    JerkControlledDrivetrain jerkControlledDrivetrain;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        jerkControlledDrivetrain = new JerkControlledDrivetrain(skyStoneDriveBase);
        waitForStart();
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("FL", jerkControlledDrivetrain.aPow());
            telemetry.update();
        }
    }
    ...
    public void cartesianSimple(double mainSpeed, double strafeSpeed, double turnSpeed)
    {
        ...
        jerkControlledDrivetrain.setMotorPowers(motorPowers.frontLeft, motorPowers.frontRight, motorPowers.rearLeft, motorPowers.rearRight);
    }
}
