...
public class StoneOrientationAnalysisCR extends OpenCvPipeline
{
    /*
     ...
     * Threshold values
     */
    static final int CR_CHAN_MASK_THRESHOLD = 80;
    ...
    ArrayList<MatOfPoint> findContours(Mat input)
    {
        ...
        Imgproc.threshold(crMat, thresholdMat, CR_CHAN_MASK_THRESHOLD, 255, Imgproc.THRESH_BINARY_INV);
    ...
    void analyzeContour(MatOfPoint contour, Mat input)
    {
        ...
        if(aboveMidlineMetrics.density < belowMidlineMetrics.density - DENSITY_UPRIGHT_THRESHOLD)
        {
            ...
            drawTagText(rotatedRectFitToContour, (int) Math.round(angle) +" deg", input);
